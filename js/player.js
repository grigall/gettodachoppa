...
let hero00  = new Player("Dutch", 'dutch', 19, 13, 9, 'Veteran Special Operator. Expert in jungle warfare. Not afraid of getting muddy.');
let hero01 = new Player("Douglas Quaid", 'quaid', 15, 12, 12, 'Mild-mannered construction worker. Likes demure women. Not a fan of parties.');
...
let hero03 = new Player("John Matrix", 'matrix', 20, 15, 8, 'Commando by trade. Lumberjack by necessity. Father of the Year.');

function setHeroes(wrapper) {
    const heroes = [hero00, hero01, hero02, hero03]
    let hero
    for (hero of heroes) {
